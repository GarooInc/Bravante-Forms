            ...
            if (dt) {
              ...
              if (dt.FechaDocumento) {
                ...
                const newM = (dObj.getUTCMonth() + 1)
                  .toString()
                  .padStart(2, "0");
                const newD = dObj.getUTCDate().toString().padStart(2, "0");
              ...
              const mesNombre = mesesNombres[parseInt(mesStr) - 1] || "enero";

              const mappedCompradores = (dt.Compradores || []).map(
                (c: any) => ({
                  ...c,
              ...
              const totalPagosNum = (rawPagos || dt.Pagos || []).reduce(
                (sum: number, p: any) => {
              ...
              const fechaEnt =
                precio.FechaEntrega || dt.fecha_entrega || dt.FechaEntrega;
              if (fechaEnt && fechaEnt.includes("-")) {
                ...
                diaEntregaLetras =
                  diaEntregaNum > 0
                    ? numberToWords(diaEntregaNum).toLowerCase()
                    : "";
              }
              ...
              payload = {
                ...
                Datos_Juridicos: {
                  ...
                  RepresentanteEdadLetras:
                    ...
                    (isJuridica
                      ? firstComp.Edad_Letras || firstComp.Edad_LeTras
                      : ""),
                  RepresentanteEstadoCivil:
                    datosJur.RepresentanteEstadoCivil ||
                    (isJuridica ? firstComp.EstadoCivil : ""),
                  ...
                  RepresentanteNacionalidad:
                    ...
                    (isJuridica ? firstComp.Nacionalidad : ""),
                ...
                Descripcion_del_Inmueble: {
                  ...
                  ParqueosAreaLetras:
                    inmueble.ParqueosAreaLetras || dt.ParqueosAreaLetras,
                  ParqueosAreaNumeros:
                    inmueble.ParqueosAreaM2 ||
                    inmueble.ParqueosAreaNumeros ||
                    dt.ParqueosAreaM2,
                  TerrazaAreaNumeros:
                    inmueble.TerrazaAreaM2 || dt.TerrazaAreaM2,
                  TerrazaAreaLetras: (() => {
                    const num = inmueble.TerrazaAreaM2 || dt.TerrazaAreaM2;
                    const letras =
                      inmueble.TerrazaAreaLetras || dt.TerrazaAreaLetras;
                    if (
                      num > 0 &&
                      (!letras || letras.toUpperCase() === "CERO")
                    ) {
                  ...
                  BalconAreaNumeros:
                    inmueble.BalconAreaM2 || dt.balcon_mts_cuadrados,
                  BalconAreaLetras: (() => {
                    const num =
                      inmueble.BalconAreaM2 || dt.balcon_mts_cuadrados;
                    const letras =
                      inmueble.BalconAreaLetras || dt.BalconAreaLetras;
                    if (
                      num > 0 &&
                      (!letras || letras.toUpperCase() === "CERO")
                    ) {
                  ...
                  TerrazaBalconAreaLetras:
                    (inmueble.TerrazaAreaM2 || dt.TerrazaAreaM2 || 0) > 0
                      ? inmueble.TerrazaAreaLetras || dt.TerrazaAreaLetras
                      : inmueble.BalconAreaLetras || dt.BalconAreaLetras,
                  ...
                  Estacionamientos: (
                    ...
                    const cleanNum = (e.Numero || "")
                      .toString()
                      .replace(/^(?:PS|BS|P\.S\.|B\.S\.)[-\s]*/i, "");
                    const cleanLetras = (e.Numero_Letras || "")
                      .toString()
                      .replace(/^(?:pe ese|be ese|ps|bs)[-\s]*/i, "");
                    return {
                      Numero: cleanNum,
                  ...
                  Bodegas: (inmueble.Bodegas || dt.Bodegas || []).map(
                    (b: any) => {
                      const cleanNum = (b.Numero || "")
                        .toString()
                        .replace(/^(?:PS|BS|P\.S\.|B\.S\.)[-\s]*/i, "");
                      const cleanLetras = (b.Numero_Letras || "")
                        .toString()
                        .replace(/^(?:pe ese|be ese|ps|bs)[-\s]*/i, "");
                      return {
                        Numero: cleanNum,
                ...
                Condiciones_Economicas: {
                  ...
                  PrecioNumeros:
                    precio.PrecioFinal || dt.PrecioFinal || dt.precio_total,
                  ReservaLetras: stripCurrency(
                    precio.ReservaLetras || dt.ReservaLetras,
                  ),
                  ReservaNumeros:
                    precio.EngancheMonto || dt.EngancheMonto || dt.enganche,
                  ...
                  TercerPagoLetras: stripCurrency(
                    precio.SaldoFinanciarLetras || dt.SaldoFinanciarLetras,
                  ),
                ...
                Datos_de_Notificacion_y_Cierre: dt.FechaDocumento
                  ? {
                      Direccion:
                        mappedCompradores && mappedCompradores.length > 0
                          ? mappedCompradores[0].Domicilio_Letras ||
                            mappedCompradores[0].Domicilio ||
                            ""
                          : "",
  ...
  const handleExportWord = async () => {
    ...
    try {
      ...
      const styles = Array.from(document.querySelectorAll("style"))
        ...
        .filter(
          (text) =>
            text.includes("documento-promesa") || text.includes("highlight-"),
        )
        .join("\n");
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <button
              ...
              style={{
                ...
                backgroundColor: showWebhookData ? "#3b82f6" : "#ffffff",
