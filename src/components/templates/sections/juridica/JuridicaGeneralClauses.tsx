...
interface JuridicaGeneralClausesProps {
    getDireccionComprador: () => string;
}

export const JuridicaGeneralClauses: React.FC<JuridicaGeneralClausesProps> = ({
        ...
        <>
            ...
            <div id="clausula-octava" className="section-spacing">
                <p>
                    ...
                    El PROMITENTE COMPRADOR Y EL PROMITENTE VENDEDOR
            ...
            <div id="clausula-decima-primera" className="section-spacing">
                <p>
                    ...
                    CENAC será la institution encargada de administrar los
