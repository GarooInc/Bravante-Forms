...
interface IndividualClause3Props extends TemplateProps {
    getSaldoFinal: () => { letras: string; numeros: string };
    getPlazoMeses: () => { letras: string; numeros: string };
    getMesEntrega: () => string;
}

export const IndividualClause3: React.FC<IndividualClause3Props> = ({
    getVal,
    getSaldoFinal,
    getPlazoMeses,
    getMesEntrega,
    ...
    return (
        <div id="clausula-tercera" className="section-spacing">
            ...
            <p>
                ...
                desde ya acepto que los bienes que por este acto promete
